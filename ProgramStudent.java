...
class ProgramStudent {
    public static void main(String args[]) {
        ...
        s2.display();
		// Example of Accessers and Mutators Methods
	System.out.println("Student 1 GPA before modification: " + s1.getGPA());
        s1.setGPA(3.5);
        System.out.println("Student 1 GPA after modification: " + s1.getGPA());
